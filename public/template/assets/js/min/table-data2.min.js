var TableData = function () {
    var a = function () {
            ...
            $("#sample_1_wrapper .dataTables_filter input").addClass("form-control input-sm").attr("placeholder", "بحث"), $("#sample_1_wrapper .dataTables_length select").addClass("m-wrap small"), $("#sample_1_wrapper .dataTables_length select").select2(), $('#sample_1_column_toggler input[type="checkbox"]').change(function () {
                var b = parseInt($(this).attr("data-column"))
                    , c = a.fnSettings().aoColumns[b].bVisible;
                a.fnSetColumnVis(b, !c)
            })
        }
        ...
        , b = function () {
            ...
            }), $("#sample_2").on("click", ".cancel-row", function (b) {
            ...
            }), $("#sample_2").on("click", ".delete-row", function (a) {
            ...
            }), $("#sample_2").on("click", ".save-row", function (a) {
                a.preventDefault();
                var b = $(this).parents("tr")[0];
                $.blockUI({
                    message: '<i class="fa fa-spinner fa-spin"></i> Do some ajax to sync with backend...'
