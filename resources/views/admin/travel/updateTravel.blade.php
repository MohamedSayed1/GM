                ...
                <div class="panel-body">
                    ...
                    <form role="form" class="form-horizontal" action="{{url('dashboard/admin/travel/update')}}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input type="text" name="hotel_name" value="{{$travel->hotel_name}}" placeholder="الفندق / السكن" id="form-field-1" class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label" for="form-field-2">
                            ...
                            <div class="col-sm-5">
                                <input type="text" name="transportaion" value="{{$travel->transportaion}}" placeholder="وسيلة المواصلات" id="form-field-2" class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label" for="form-field-2">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input type="date" name="end_day" value="{{$travel->end_day}}" placeholder="تاريخ العودة" id="form-field-2" class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label" for="form-field-2">
                            ...
                            <div class="col-sm-5">
                                <select id="form-field-select-1" name="is_active" class="form-control">
                                    @if($travel->is_active==1)
                                      <option selected value="1">قامت</option>
                                      <option value="0">لم تقم</option>
                                    @else
                                        <option selected value="0">لم تقم</option>
