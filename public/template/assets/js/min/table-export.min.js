var TableExport = function() {
    ...
    var a = function() {
        function a(a, b) {
            for (var c = a.fnGetData(b), d = $(">td", b), e = 0, f = d.length; f > e; e++)
                a.fnUpdate(c[e], b, e, !1);
            a.fnDraw()
        }
        function b(a, b) {
            var c = a.fnGetData(b)
              , d = $(">td", b);
            d[0].innerHTML = '<input type="text" class="form-control" value="' + c[0] + '">',
            d[1].innerHTML = '<input type="text" class="form-control" value="' + c[1] + '">',
            d[2].innerHTML = '<input type="text" class="form-control" value="' + c[2] + '">',
            d[3].innerHTML = '<a class="save-row" href="">Save</a>',
            d[4].innerHTML = '<a class="cancel-row" href="">Cancel</a>'
        }
        function c(a, b) {
            var c = $("input", b);
            a.fnUpdate(c[0].value, b, 0, !1),
            a.fnUpdate(c[1].value, b, 1, !1),
            a.fnUpdate(c[2].value, b, 2, !1),
            a.fnUpdate('<a class="edit-row" href="">Edit</a>', b, 3, !1),
            a.fnUpdate('<a class="delete-row" href="">Delete</a>', b, 4, !1),
            a.fnDraw(),
            d = !1,
            e = null
        }
        ...
        $("#sample-table-2_wrapper .dataTables_filter input").addClass("form-control input-sm").attr("placeholder", "بحث"),
